...
public class RepositorioCenario{
    ...
    public void EscolhaDoCenario(){
        cenarios.get("Casa do Jogador").setEscolha ("1-Ir para a Capital\n");

        cenarios.get("Centro da Capital").setEscolha ("1-Ir para a Favela\n" +
        ...
        cenarios.get("Subúrbio").setEscolha ("1-Entrar no bar\n" +
        ...
        cenarios.get("Subúrbio - Olhar em volta").setEscolha("1-Tentar ajudá-lo com seus conhecimentos médicos. [Requisito: Medicina 2+]\n" +
        ...
        cenarios.get("Bar").setEscolha ("1-[Requisito: Medicina 2+] \"Onde há praga, há trabalho para mim. Inclusive, compreendo de ferimentos e escutei alguns gemidos de dor vindo dos fundos. Talvez eu possa ajudar em algo.\"\n" +
        ...
        cenarios.get("Casa do Silas").setEscolha ("1-Ler os livros e grimórios na estante.\n" +
        ...
        cenarios.get("Laboratório Clandestino").setEscolha ("1-Passar 1 Dia pesquisando. [-10 Moedas de Ouro]\n" +
                "2-Entregar a Caixa Misteriosa (Se adquirida na casa de Silas).\n" +
                "3-Voltar ao Subúrbio.\n");

        cenarios.get("Laboratório Clandestino - Etapa Concluída").setEscolha ("1-Ir para o Bairro Nobre\n");

        cenarios.get("Portões do Bairro Nobre (Sem Passe)").setEscolha (
        ...
        cenarios.get("Bairro Nobre").setEscolha (
        ...
        cenarios.get("Bairro Nobre - Olhar em volta").setEscolha (
        ...
        cenarios.get("Taverna Nobre").setEscolha (
        ...
        cenarios.get("Catedral").setEscolha (
        ...
        cenarios.get("Mansão").setEscolha (
        ...
        cenarios.get("Castelo Real").setEscolha (
        ...
        cenarios.get("Castelo Real - Retorno à Catedral").setEscolha (
        ...
        cenarios.get("Castelo Real - Encontrar Traidor").setEscolha (
    ...
    public void atribuirTexto() {
        ...
        cenarios.get("Casa do Jogador").getFalas().add(                "\"Saudações,\n" +
        ...
        // CAPITAL
        cenarios.get("Centro da Capital").getFalas().add(                "Ao atravessar os grandes portões e adentrar o centro da Capital, o contraste com a antiga glória de Oblitum é brutal.\n" +
        ...
        // SUBÚRBIO
        cenarios.get("Subúrbio").getFalas().add(                "Ao chegar ao Subúrbio, o cenário é desolador. O ambiente é barulhento, caótico e tomado por odor terrível de sujeira e doença.\n" +
        ...
        cenarios.get("Subúrbio - Olhar em volta").getFalas().add(                "Observando o caos ao redor, você nota um grupo de pessoas em pânico no meio da rua lamacenta.\n" +
        ...
        cenarios.get("Subúrbio - Sucesso Medicina").getFalas().add(                "[Sucesso]: Você após analisar a criança, percebe que sua doença não se trata da peste e sim de uma febre comum.\n" +
        ...
        cenarios.get("Subúrbio - Sucesso Classe").getFalas().add(                "[Sucesso]: Você assume o controle da situação com voz firme, ordenando que deem espaço.\n" +
        ...
        cenarios.get("Subúrbio - Sucesso Fé").getFalas().add(                "[Sucesso]: Você se ajoelha com postura solene, entoando orações em latim para acalmar a família.\n" +
        ...
        cenarios.get("Subúrbio - Falha").getFalas().add(                "[Falha]: Você tenta intervir, mas hesita e demonstra insegurança. O estado do garoto parece piorar.\n" +
        ...
        // BAR
        cenarios.get("Bar").getFalas().add(                "Ao entrar no bar, você se sente acolhido e, ao olhar em volta, percebe que aquele lugar se tornou um refúgio para as pessoas.\n" +
        ...
        cenarios.get("Bar - Sucesso Medicina").getFalas().add(                "[Sucesso]: Silas o leva aos fundos, onde você descobre que os gemidos vêm da filhinha dele, gravemente doente.\n" +
        ...
        cenarios.get("Bar - Falha Medicina").getFalas().add(                "[Falha]: Silas o leva aos fundos, mas ao analisar a criança, você percebe que a doença está avançada e seu experimento ainda não está pronto para consumo humano — administrá-lo agora a mataria.\n" +
        ...
        cenarios.get("Bar - Sucesso Classe").getFalas().add(                "[Sucesso]: O barman analisa suas anotações e sua postura. Ele revela ser um ex-estudante de medicina e confessa que aquelas deduções escritas no caderno são as mais promissoras que ele viu em semanas.\n" +
        ...
        cenarios.get("Bar - Falha Classe").getFalas().add(                "[Falha]: Silas folheia o caderno, mas logo percebe as anotações ralas e a sua forma rude de falar, que não condiz com a de um verdadeiro estudioso.\n" +
        ...
        cenarios.get("Bar - Sucesso Fé").getFalas().add(                "[Sucesso]: Você diz que vai orar para saber se Silas é um homem digno. Enquanto finge estar em transe, você escuta os sussurros dos clientes ao redor elogiando o barman e lamentando que a filha dele tenha sido contaminada.\n" +
        ...
        cenarios.get("Bar - Falha Fé").getFalas().add(                "[Falha]: Silas olha para você com aversão profunda. Em tempos de praga, ele já viu fanáticos demais lucrando com o medo alheio.\n" +
        ...
        // CASA DO SILAS
        cenarios.get("Casa do Silas").getFalas().add(                "Ao usar a chave entregue pelo barman, a fechadura enferrujada cede com um estalo seco.\n" +
        ...
        cenarios.get("Casa do Silas - Livros").getFalas().add(                "Você ignora os bens materiais e passa os próximos minutos folheando freneticamente as anotações médicas de Silas e velhos tratados de anatomia.\n" +
        ...
        cenarios.get("Casa do Silas - Bolsa").getFalas().add(                "Sobrevivência exige capital. Você agarra a bolsa de lona grossa. O som inconfundível de moedas tilintando preenche o silêncio.\n" +
        ...
        cenarios.get("Casa do Silas - Caixa").getFalas().add(                "Atraído pela caixa esculpida com símbolos estranhos, você quebra o fecho de metal.\n" +
        ...
        cenarios.get("Laboratório Clandestino").getFalas().add(                "Você continua avançando cada vez mais fundo nas favelas. A quantidade de cadáveres amontoados aumenta a cada esquina, até que o mapa o guia para um beco mais escuro e estreito que o normal.\n" +
        ...
        cenarios.get("Laboratório Clandestino - Pesquisar").getFalas().add(                "Você se dedica a auxiliar nas experimentações ao longo do dia, suportando o odor terrível.\n" +
                        "[Custo/Recompensa: -10 Moedas de Ouro, +1 Ponto em Medicina, -1 Dia Restante, +1 Amizade com Laila]\n");

        cenarios.get("Laboratório Clandestino - Entregar Caixa").getFalas().add(                "Você entrega o catalisador perfeito a Laila. Os olhos da pesquisadora brilham ao ver a pureza do reagente. Isso avança a pesquisa drasticamente.\n" +
        ...
        // PESQUISA CONCLUÍDA
        cenarios.get("Laboratório Clandestino - Etapa Concluída").getFalas().add(                "— O processo de decantação levará 5 dias para ficar estável — diz Laila, tossindo levemente. — Não fique aqui respirando esta fumaça tóxica.\n" +
        ...
        cenarios.get("Laboratório Clandestino - Retorno 5 Dias").getFalas().add(                "Ao retornar após os 5 dias, a fumaça abaixa. Laila segura um frasco maior contra a luz.\n" +
        ...
        cenarios.get("Portões do Bairro Nobre (Sem Passe)").getFalas().add(                "Ao deixar as favelas para trás, o ar começa a ficar menos espesso. O caminho de terra e lama dá lugar a ruas pavimentadas e limpas, até que seu avanço é interrompido.\n" +
        ...
        cenarios.get("Portões - Sucesso Carta").getFalas().add(                "[Sucesso]: O capitão da guarda arregala os olhos ao reconhecer o antigo selo de cera. \"Um assunto confidencial da Conselheira Zuri... Perdoe a minha insolência\".\n" +
                        "Ele abre caminho imediatamente, entregando-lhe um Passe de Livre Trânsito.\n");

        cenarios.get("Portões - Sucesso Atributos").getFalas().add(                "[Sucesso]: O guarda engole seco, recuando as lanças. Seja por respeito à sua utilidade, medo de sua autoridade ou temor divino, ele pede desculpas e entrega a você um Passe de Livre Trânsito cunhado em prata.\n" +
                        "Agora você pode entrar e sair do Bairro Nobre quando quiser.\n");

        cenarios.get("Portões - Falha").getFalas().add(                "[Falha]: O guarda ri da sua tentativa patética. Ele o empurra com o cabo da lança e ameaça prendê-lo se não sumir dali.\n" +
                        "Você é barrado e precisa encontrar outra forma de conseguir o passe.\n");

        // BAIRRO NOBRE (COM PASSE)
        cenarios.get("Bairro Nobre").getFalas().add(                "Ao cruzar os portões de ferro, a realidade muda de forma drástica e perturbadora. É como se a Peste Babilônica não passasse de um mito distante.\n" +
        ...
        cenarios.get("Bairro Nobre - Olhar em volta").getFalas().add(                "Ao olhar em volta pelos jardins perfeitamente podados da praça, você nota uma criança choramingando sozinha.\n" +
        ...
        cenarios.get("Praça - Sucesso Medicina").getFalas().add(                "[Sucesso]: Você limpa o ferimento rapidamente com um unguento, aliviando a dor. A criança para de chorar e agradece, impressionada com sua habilidade.\n" +
        ...
        cenarios.get("Praça - Sucesso Classe").getFalas().add(                "[Sucesso]: Você fala com ele de igual para igual, com eloquência, ensinando que a dor forja líderes. O garoto seca as lágrimas, recompõe a postura e diz que o seu jeito de falar lembra muito o do pai dele.\n" +
        ...
        cenarios.get("Praça - Sucesso Fé").getFalas().add(                "[Sucesso]: Suas orações e a presença calmante da Igreja fazem o garoto esquecer a dor. Ele presta respeito, maravilhado, e afirma que Deus deve tê-lo enviado.\n" +
        ...
        cenarios.get("Praça - Falha").getFalas().add(                "[Falha]: Você se aproxima de forma muito brusca ou assustadora. Acostumado a ser bajulado, o garoto nobre se assusta com a sua presença,\n" +
                        "começa a gritar por socorro e sai correndo para casa, deixando você de mãos vazias.\n");

        // TAVERNA NOBRE
        cenarios.get("Taverna Nobre").getFalas().add(                "Ao observar o ambiente luxuoso da taverna com mais atenção, o contraste se torna evidente. O ouro e a seda não escondem a vulnerabilidade humana.\n" +
        ...
        cenarios.get("Taverna Nobre - Sucesso Medicina").getFalas().add(                "[Sucesso]: Ao se aproximar, seus olhos treinados e sua audição diagnosticam rapidamente a causa da tosse, descartando a praga.\n" +
        ...
        cenarios.get("Taverna Nobre - Sucesso Classe").getFalas().add(                "[Sucesso]: Você se debruça sobre a mesa e escuta o garoto resmungando. Imediatamente, reconhece o texto como um antigo tratado médico.\n" +
        ...
        cenarios.get("Taverna Nobre - Sucesso Fé").getFalas().add(                "[Sucesso]: Você se aproxima e oferece conforto. A senhora desabafa que perdeu o marido e o filho para a peste e que a quarentena a impediu de ir à Igreja para orar por suas almas.\n" +
        ...
        cenarios.get("Taverna Nobre - Falha").getFalas().add(                "[Falha]: Ao se aproximar e tentar interagir, você hesita. Rapidamente fica evidente que lhe faltam o conhecimento e o traquejo social necessários para lidar com a situação.\n" +
        ...
        // CATEDRAL
        cenarios.get("Catedral").getFalas().add(                "Ao empurrar as pesadas portas de carvalho esculpido, o som do caos e do sofrimento lá fora desaparece, substituído pelo eco de cânticos distantes.\n" +
        ...
        cenarios.get("Catedral - Opção 1").getFalas().add(                "O Cardeal abre um sorriso ganancioso e seus olhos brilham ao ver as moedas. Ele recolhe o ouro rapidamente e, durante as horas seguintes, compartilha antigas escrituras,\n" +
        ...
        cenarios.get("Catedral - Opção 2").getFalas().add(                "O Cardeal pesa a bolsa de moedas na mão, visivelmente satisfeito com o peso do ouro. Sem hesitar, ele assina um pergaminho, derrama cera quente e o carimba com o seu pesado anel de sinete, entregando-o a você com desdém.\n" +
        ...
        cenarios.get("Catedral - Opção 3").getFalas().add(                "O rosto do Cardeal se contorce em fúria. — Insolente! Este ouro é a manifestação terrena da glória do Senhor!\n" +
        ...
        cenarios.get("Mansão").getFalas().add(                "Ao entrar na mansão do Duque Rodrigo, você se depara com um ambiente que transpira intelecto e poder.\n" +
        ...
        cenarios.get("Mansão - Opção 1").getFalas().add(                "Zuri quebra o selo e lê a carta discretamente. Seus olhos brilham ao perceber que a cura está pronta.\n" +
        ...
        cenarios.get("Mansão - Opção 2").getFalas().add(                "Zuri sorri levemente, satisfeita com a sua perspicácia. Ela recolhe as moedas com um aceno elegante e, pelas próximas horas, submete você a um treinamento intensivo.\n" +
        ...
        cenarios.get("Mansão - Opção 3").getFalas().add(                "O Duque suspira profundamente, ofendido. Ele se recusa a assinar.\n" +
        ...
        // CASTELO REAL
        cenarios.get("Castelo Real").getFalas().add(                "Os imensos portões do Castelo Real se abrem com um estrondo.\n" +
        ...
        cenarios.get("Castelo Real - Opção 1").getFalas().add(                "O Rei, surpreso, ordena que o frasco seja testado em um servo infectado ali mesmo.\n" +
        ...
        cenarios.get("Castelo Real - Opção 2").getFalas().add(                "O Rei sorri de forma cruel. Ele está exausto das exigências da Igreja e vê na sua proposta a desculpa perfeita para abrir os cofres do clero.\n" +
        ...
        cenarios.get("Castelo Real - Opção 3").getFalas().add(                "O Rei se levanta bruscamente, a coroa quase escorregando de sua cabeça. A paranoia toma conta dos seus olhos.\n" +
        ...
        cenarios.get("Castelo Real - Retorno à Catedral").getFalas().add(
        ...
        cenarios.get("Retorno à Catedral - Opção 1").getFalas().add(
        ...
        cenarios.get("Retorno à Catedral - Opção 2").getFalas().add(
        ...
        cenarios.get("Retorno à Catedral - Opção 3").getFalas().add(
        ...
        cenarios.get("Retorno à Catedral - Final").getFalas().add(                "Seja pela força da lei (Classe) ou pela conversão dos guardas (Fé), o Cardeal cai de joelhos, derrotado. Os baús secretos da Catedral são abertos, revelando uma riqueza obscena.\n" +
        ...
        cenarios.get("Castelo Real - Encontrar Traidor").getFalas().add(                "Você marcha com a Guarda Real em direção à Mansão do Duque Rodrigo.\n" +
        ...
        cenarios.get("Encontrar Traidor - Consequência 1 e 3").getFalas().add(                "O Duque Rodrigo é arrastado para fora de sua mansão a ferros. Zuri assume a liderança política da casa e financia a produção da cura de Laila.\n" +
        ...
        cenarios.get("Encontrar Traidor - Consequência 2").getFalas().add(                "O Duque aceita seu acordo sombrio, tremendo de medo. Você mente para a Coroa, incriminando um inimigo qualquer, e distribui a cura sendo aclamado como herói.\n" +
        ...
        cenarios.get("Game Over - O Abraço de Oblitum").getFalas().add(                "Seu corpo não suporta mais. Com os ferimentos acumulados, a exaustão física e o ar envenenado da Capital invadindo seus pulmões, suas pernas finalmente cedem.\n" +
