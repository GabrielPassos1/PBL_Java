...
public class RepositorioPersonagens {
    ...
    public void atribuirTexto() {
        //Falas do Guia
        personagens.get("Jeffrey").getFalas().add("A peste varreu a parte baixa sem piedade.\n" +
        ...
        personagens.get("Jeffrey").getFalas().add("Os ricos se trancaram atrás de portões de ferro. Quase não há casos de contaminação por lá.\n"+
        ...
        personagens.get("Jeffrey").getFalas().add("Lá no alto, o Rei lida com palavras, não com a morte. O castelo virou um ninho de discussões políticas diárias.\n"+
        ...
        personagens.get("Sillas").getFalas().add("— O meu nome é Silas — a voz grossa dele soa quase como um rosnado cansado.—\n"+ "" +
